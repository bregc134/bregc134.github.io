$(window).keypress(function(e) {
  ...
  if (e.which == 97 || e.which == 65) {
  	$("body").append($(".a-marker").clone().removeClass("a-marker"));
  }

  if (e.which == 98 || e.which == 66) {
  	$("body").append($(".b-marker").clone().removeClass("b-marker"));
  }

   if (e.which == 99 || e.which == 67) {
  	$("body").append($(".c-marker").clone().removeClass("c-marker"));
  }

   if (e.which == 100 || e.which == 68) {
  	$("body").append($(".d-marker").clone().removeClass("d-marker"));
  }

   if (e.which == 101 || e.which == 69) {
  	$("body").append($(".e-marker").clone().removeClass("e-marker"));
  }
